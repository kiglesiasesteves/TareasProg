...
public class Guerrero implements Atributos, Combatiente{
    ...
    public Guerrero() {
        ...
        atributosMap.put("Vigor", 11);
        atributosMap.put("Mente", 12);
        atributosMap.put("Aguante", 11);
        atributosMap.put("Fuerza", 10);
        atributosMap.put("Destreza", 16);
        atributosMap.put("Inteligencia", 10);
