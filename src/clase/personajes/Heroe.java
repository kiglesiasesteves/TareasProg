...
public class Heroe implements Atributos, Combatiente{
    ...
    public Heroe(){
        ...
        atributosMap.put("Vigor", 14);
        atributosMap.put("Mente", 9);
        atributosMap.put("Aguante", 12);
        atributosMap.put("Fuerza", 16);
        atributosMap.put("Destreza", 9);
        atributosMap.put("Inteligencia", 7);
        atributosMap.put("Fe", 8);
        atributosMap.put("Arcano", 11);
