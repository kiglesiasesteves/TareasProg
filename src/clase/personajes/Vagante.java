...
public class Vagante implements Atributos, Combatiente{
    ...
    public Vagante() {
        ...
        atributosMap.put("Vigor", 15);
        atributosMap.put("Mente", 10);
        atributosMap.put("Aguante", 11);
        atributosMap.put("Fuerza", 14);
        atributosMap.put("Destreza", 13);
        atributosMap.put("Inteligencia", 9);
        atributosMap.put("Fe", 9);
        atributosMap.put("Arcano", 7);
