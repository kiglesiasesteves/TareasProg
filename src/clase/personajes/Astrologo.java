...
public class Astrologo implements Atributos, Combatiente{
    ...
    public Astrologo(){
        ...
        atributosMap.put("Vigor", 6);
        atributosMap.put("Mente", 9);
        atributosMap.put("Aguante", 15);
        atributosMap.put("Fuerza", 8);
        atributosMap.put("Destreza", 12);
        atributosMap.put("Inteligencia", 16);
        atributosMap.put("Fe", 7);
        atributosMap.put("Arcano", 9);
